  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl overflow-hidden flex flex-col h-full transition-transform duration-300 hover:scale-105">
      ...
      <div className="flex flex-col flex-grow">
        <div
          className="w-full px-4 py-2 transition-all font-semibold border-white  hover:bg-teal-500 bg-[#151f28] hover:text-[#151f28] text-lg md:text-base text-teal-500 mt-auto space-y-3"
        >
          {/* Title */}
